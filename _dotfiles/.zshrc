...
# Home key - multiple escape sequence formats
bindkey '^[[H'   beginning-of-line  # CSI H (most common)
bindkey '^[OH'   beginning-of-line  # SS3 H (application mode)
bindkey '^[[1~'  beginning-of-line  # VT100/xterm format

# End key - multiple escape sequence formats
bindkey '^[[F'   end-of-line        # CSI F (most common)
bindkey '^[OF'   end-of-line        # SS3 F (application mode)
bindkey '^[[4~'  end-of-line        # VT100/xterm format

# Page Up/Page Down - These will be handled by tmux for buffer scrolling
# When not in tmux, these scroll the terminal buffer directly
# Note: Inside tmux, Page Up/Down are intercepted by tmux itself
...
# Alt+Arrow keys - handled by tmux for pane navigation, but define shell fallback
